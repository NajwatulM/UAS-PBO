...
public class pesanController extends dataController {
    ...
    private void cetakAction(ActionEvent event) throws SQLException, IOException {
        ...
        if(jumlahKursiPembeli.isBlank() || jumlahKursiPembeli.equals(0)){
            alert2.setOpacity(1.0);
        } else if(namaPembeli.isBlank()){
            alert1.setOpacity(1.0);
        } else {
